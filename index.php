...
if (!file_exists("po-library/po-config.php")){
	...
	include_once 'po-admin/po-component/po-menumanager/includes/config.php';
	...
	$connection = mysqli_connect($dbhostsql, $dbusersql, $dbpasswordsql) or die(mysqli_connect_error());
