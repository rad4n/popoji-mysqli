...
<?php if ($member_register == "Y"){ if ($mod=="home"){ ?>
	...
	<form name="login-form" method="post" action="<?=$website_url;?>/po-admin/login.php" autocomplete="off">
...
<form name="register-form" method="post" action="<?=$website_url;?>/po-admin/actregister.php" autocomplete="off">
	<input type="text" name="username" id="username" placeholder="Username" />
