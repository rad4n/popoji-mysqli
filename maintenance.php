...
<head>
	...
	<link type="text/css" rel="stylesheet" href="po-admin/css/bootstrap.min.css" />
	<link type="text/css" rel="stylesheet" href="po-admin/css/maintenance.css" />
</head>
<body>
	<section id="intro">
		<div class="container">
	...
	<script type="text/javascript" src="po-admin/js/vendor/jquery-1.11.0.min.js"></script>
	<script type="text/javascript" src="po-admin/js/vendor/jquery.counteverest.min.js"></script>
